    ...
    <fieldset>
        ...
        <div class="control-group">
          ...
          <div class="controls">
            <select id="type" name="type">
              <li:dictOptions dictType="affiche-type" dictValue="${affiche.type }" />
            </select>
          </div>
        </div>
      </div>
      <div class="row-fluid">
        <div class="control-group">
          ...
          <div class="controls">
              <input id="title" name="title" type="text" value="${li:out(affiche.title) }" />
          </div>
        </div>
      </div>
      <div class="row-fluid">
        <div class="control-group">
          ...
          <div class="controls">
            <div class="input-append date datepicker" id="expiredDate" data-date-format="yyyy-mm-dd">
                <input id="expiredDate" name="expiredDateFmt" type="text" value="${li:formatDate(affiche.expiredDate) }"/>
      ...
      <div class="row-fluid">
        <div class="control-group">
          ...
          <div class="controls">
            <textarea id="content" name="content" style="width:700px;height:300px;">${li:out(affiche.content) }</textarea>
          </div>
        </div>
      </div>
      <div class="row-fluid">
        <div class="control-group">
          <label class="control-label" for="isCheckedYes"><s:message code="affiche.isChecked" /></label>
          <div class="controls">
