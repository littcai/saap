	  ...
	  <div class="span10 offset1">
	  	<div class="widget-box">
	  		<div class="widget-header header-color-blue">
	        	<h5 class="bigger lighter"><s:message code="resetPassword" /></h5>
	        </div>
	        <div class="widget-body">
	        	<div class="widget-main">
			       ...
			       <form id="theform" name="theform" action="resetPassword.json" method="post" class="form-horizontal">
							...
							<div class="control-group">
								...
								<div class="controls">
									<div class="input-prepend">
										...
										<input class="" type="password" id="register_password" placeholder="<s:message code='resetPassword.newPassword' />" name="password"/>
									</div>
