			...
			<table class="table table-striped table-bordered table-hover datatable">
				<thead>
					<tr>			
						...
						<th><s:message code="knowledgeSpace.id" /></th>
						<th><s:message code="knowledgeSpace.tenantId" /></th>
						<th><s:message code="knowledgeSpace.code" /></th>
						<th><s:message code="knowledgeSpace.name" /></th>
						<th><s:message code="knowledgeSpace.descr" /></th>
						<th><s:message code="knowledgeSpace.createUserId" /></th>
						<th><s:message code="knowledgeSpace.createDatetime" /></th>
						<th><s:message code="knowledgeSpace.updateUserId" /></th>
						<th><s:message code="knowledgeSpace.updateDatetime" /></th>
				...
				<c:forEach items="${pageList.rsList }" var="row">
					<tr>
						<td class="checkCol"><input type="checkbox" name="knowledgeSpaceIds" value="${row.id }" /></td>
