			...
			<table class="table table-striped table-bordered table-hover datatable">
				<thead>
					<tr>			
						...
						<th><s:message code="knowledgePage.id" /></th>
						<th><s:message code="knowledgePage.tenantId" /></th>
						<th><s:message code="knowledgePage.spaceId" /></th>
						<th><s:message code="knowledgePage.parentId" /></th>
						<th><s:message code="knowledgePage.subject" /></th>
						<th><s:message code="knowledgePage.brief" /></th>
						<th><s:message code="knowledgePage.keywords" /></th>
						<th><s:message code="knowledgePage.content" /></th>
						<th><s:message code="knowledgePage.createUserId" /></th>
						<th><s:message code="knowledgePage.createDatetime" /></th>
						<th><s:message code="knowledgePage.updateUserId" /></th>
						<th><s:message code="knowledgePage.updateDatetime" /></th>
				...
				<c:forEach items="${pageList.rsList }" var="row">
					<tr>
						<td class="checkCol"><input type="checkbox" name="knowledgePageIds" value="${row.id }" /></td>
						<td><c:out value="${row.id }"></c:out></td>
						<td><c:out value="${row.tenantId }"></c:out></td>
						<td><c:out value="${row.spaceId }"></c:out></td>
						<td><c:out value="${row.parentId }"></c:out></td>
						<td><c:out value="${row.subject }"></c:out></td>
						<td><c:out value="${row.brief }"></c:out></td>
						<td><c:out value="${row.keywords }"></c:out></td>
