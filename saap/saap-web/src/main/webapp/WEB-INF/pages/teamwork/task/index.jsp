			...
			<table class="table table-striped table-bordered table-hover datatable">
				<thead>
					<tr>			
						...
						<th><s:message code="task.id" /></th>
						<th><s:message code="task.tenantId" /></th>
						<th><s:message code="task.projectId" /></th>
						<th><s:message code="task.title" /></th>
						<th><s:message code="task.content" /></th>
						<th><s:message code="task.priority" /></th>
						<th><s:message code="task.status" /></th>
						<th><s:message code="task.assignee" /></th>
						<th><s:message code="task.tags" /></th>
						<th><s:message code="task.createUserId" /></th>
						<th><s:message code="task.createDatetime" /></th>
						<th><s:message code="task.updateUserId" /></th>
						<th><s:message code="task.updateDatetime" /></th>
				...
				<c:forEach items="${pageList.rsList }" var="row">
					<tr>
						<td class="checkCol"><input type="checkbox" name="taskIds" value="${row.id }" /></td>
						...
						<td><c:out value="${row.priority }"></c:out></td>
						<td><c:out value="${row.status }"></c:out></td>
						<td><c:out value="${row.assignee }"></c:out></td>
