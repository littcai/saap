					...
					<div class="row-fluid">
						<div class="span6">
							<div class="control-group">
								...
								<div class="controls">
									<input id="id" name="id" placeholder="" type="text" value="${topic.id}" />
								</div>
							</div>
						</div>								
						<div class="span6">
							<div class="control-group">
								...
								<div class="controls">
									<input id="tenantId" name="tenantId" placeholder="" type="text" value="${topic.tenantId}" />
								</div>
							</div>
						</div>								
					</div>
					<div class="row-fluid">
						<div class="span6">
							<div class="control-group">
								...
								<div class="controls">
									<input id="projectId" name="projectId" placeholder="" type="text" value="${topic.projectId}" />
								</div>
							</div>
						</div>								
						<div class="span6">
							<div class="control-group">
								...
								<div class="controls">
									<input id="title" name="title" placeholder="" type="text" value="${topic.title}" />
								</div>
							</div>
						</div>								
					</div>
					<div class="row-fluid">
						<div class="span6">
							<div class="control-group">
								...
								<div class="controls">
									<input id="content" name="content" placeholder="" type="text" value="${topic.content}" />
								</div>
							</div>
						</div>								
						<div class="span6">
							<div class="control-group">
								...
								<div class="controls">
									<input id="createUserId" name="createUserId" placeholder="" type="text" value="${topic.createUserId}" />
								</div>
							</div>
						</div>								
					</div>
					<div class="row-fluid">
						<div class="span6">
							<div class="control-group">
								...
								<div class="controls">
									<input id="createDatetime" name="createDatetime" placeholder="" type="text" value="${topic.createDatetime}" />
								</div>
							</div>
						</div>								
						<div class="span6">
							<div class="control-group">
								...
								<div class="controls">
									<input id="updateUserId" name="updateUserId" placeholder="" type="text" value="${topic.updateUserId}" />
								</div>
							</div>
						</div>								
					</div>
					<div class="row-fluid">
						<div class="span6">
							<div class="control-group">
								...
								<div class="controls">
									<input id="updateDatetime" name="updateDatetime" placeholder="" type="text" value="${topic.updateDatetime}" />
								</div>
							</div>
						</div>								
					</div>
