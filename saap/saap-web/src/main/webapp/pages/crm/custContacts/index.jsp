			...
			<table class="table table-striped table-bordered table-hover datatable">
				<thead>
					<tr>			
						...
						<th class="sort customerId"><s:message code="Contacts.customerId" /></th>
						<th class="sort name"><s:message code="Contacts.name" /></th>
						<th><s:message code="Contacts.gender" /></th>
				...
				<c:forEach items="${pageList.rsList }" var="row">
					<tr>
						...
						<th><c:out value="${row.customer.customerId }"></c:out></th>
						<th><c:out value="${row.custContacts.name }"></c:out></th>
						<th><c:out value="${row.custContacts.gender }"></c:out></th>
						<th><c:out value="${row.custContacts.mobile }"></c:out></th>
						<th><c:out value="${row.custContacts.email }"></c:out></th>
						<th><c:out value="${row.custContacts.phone }"></c:out></th>
