!function($){
  ...
  * ================================= */
  ...
  , onblur: function(dataValue, realValue){
	  /*
	     * add by cai
	     * if select none, then clean the input
        */
  ...
  , select: function () {
      ...
      this.$element
        .val(this.updater(val, realVal)).attr("data-value", val).attr("real-value",realVal)
        .change()
      return this.hide()
    }
  ...
  , blur: function (e) {
      this.focused = false
      var realValue = this.$element.attr("real-value");
	  var dataValue = this.$element.attr("data-value");
      this.onblur(dataValue, realValue);
